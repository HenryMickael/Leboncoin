...
const AnnonceDetail = () => {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      // Rediriger vers la liste des annonces après la suppression réussie
    ...
    <div className="annonce-detail-container">
      {loading ? (
        ...
        <div>
          ...
          {/* Affiche le bouton de suppression si l'annonce a été créée par l'utilisateur actuellement connecté */}
